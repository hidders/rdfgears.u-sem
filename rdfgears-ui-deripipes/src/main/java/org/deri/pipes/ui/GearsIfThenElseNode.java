 ...
 *
 */
public class GearsIfThenElseNode extends Gears_FixedInput_AbstractNNRCNode {
	
	public GearsIfThenElseNode(int x, int y){
		super(x,y);
	}
	...
	public static GearsIfThenElseNode loadConfig(Element elm, PipeEditor wsp){
		GearsIfThenElseNode node = new GearsIfThenElseNode(
